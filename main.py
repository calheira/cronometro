...
def create_window():
    ...
    layout = [
        ...
        [sg.VPush()],
        [sg.Text('', font='Ubuntu 50', key = '-TIME-')],
        [
            sg.Button('Start', button_color=('white','red'), border_width=0, key='-STARTSTOP-'),
            sg.Button('Lap', button_color=('white','red'), border_width=0, key='-LAP-', visible=False)
        ],
        [sg.Column([[]], key='-LAPS-')],
        [sg.VPush()]
    ]
